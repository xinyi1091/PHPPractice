CREATE TABLE `user` (
  `user_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_name` varchar(20) NOT NULL COMMENT '用户名',
  `user_pwd` char(32) NOT NULL COMMENT '密码',
  `user_face` varchar(50) DEFAULT NULL COMMENT '头像',
  `user_login_ip` int(11) DEFAULT NULL COMMENT '最后登录的IP',
  `user_login_time` int(10) unsigned DEFAULT NULL COMMENT '最后登录的时间',
  `user_login_count` smallint(5) unsigned DEFAULT '0' COMMENT '登录次数',
  `is_admin` tinyint(4) DEFAULT '0' COMMENT '超级管理员',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户表';

CREATE TABLE `sess` (
  `sess_id` varchar(50) NOT NULL COMMENT '会话编号',
  `sess_value` text COMMENT '会话值',
  `sess_time` int(10) unsigned NOT NULL COMMENT '会话产生时间',
  PRIMARY KEY (`sess_id`)
...
INSERT INTO `products` ( `proID`, `proname`, `proguige`, `proprice`, `proamount`, `proimages`, `proweb` )
VALUES
